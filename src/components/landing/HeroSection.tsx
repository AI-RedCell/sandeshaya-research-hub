...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center relative z-10 px-4 pt-16">
        <div className="text-center">
          ...
          {/* Subtitle */}
          <h2 className="text-white/95 mb-4 text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium drop-shadow-lg px-4">
            National Student Research on Media Ethics
          </h2>
          
          {/* Description */}
          <p className="text-base sm:text-lg md:text-xl text-white/80 max-w-2xl mx-auto drop-shadow leading-relaxed mb-6 px-4">
          ...
          {/* Survey Info Badge */}
          <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-full px-6 py-2 mb-8 border border-white/20">
      ...
      <div className="relative z-10 pb-12 sm:pb-16 text-center">
        <Button 
          variant="default" 
          size="lg" 
          asChild 
          className="bg-secondary hover:bg-secondary/95 text-maroon font-bold px-8 sm:px-12 py-5 sm:py-7 text-lg sm:text-xl rounded-full transition-all duration-300 border-b-4 border-secondary/70 hover:border-secondary/50 hover:translate-y-[-2px] active:translate-y-[1px] active:border-b-2"
          style={{ 
