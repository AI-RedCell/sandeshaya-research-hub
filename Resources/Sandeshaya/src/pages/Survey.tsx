...
const englishValues: Record<string, Record<string, string>> = {
  ...
  // Districts
  'q.district.ampara': { value: 'Ampara' },
  'q.district.anuradhapura': { value: 'Anuradhapura' },
  'q.district.badulla': { value: 'Badulla' },
  'q.district.batticaloa': { value: 'Batticaloa' },
  'q.district.colombo': { value: 'Colombo' },
  'q.district.galle': { value: 'Galle' },
  'q.district.gampaha': { value: 'Gampaha' },
  'q.district.hambantota': { value: 'Hambantota' },
  'q.district.jaffna': { value: 'Jaffna' },
  'q.district.kalutara': { value: 'Kalutara' },
  'q.district.kandy': { value: 'Kandy' },
  'q.district.kegalle': { value: 'Kegalle' },
  'q.district.kilinochchi': { value: 'Kilinochchi' },
  'q.district.kurunegala': { value: 'Kurunegala' },
  'q.district.mannar': { value: 'Mannar' },
  'q.district.matale': { value: 'Matale' },
  'q.district.matara': { value: 'Matara' },
  'q.district.monaragala': { value: 'Monaragala' },
  'q.district.mullaitivu': { value: 'Mullaitivu' },
  'q.district.nuwaraeliya': { value: 'Nuwara Eliya' },
  'q.district.polonnaruwa': { value: 'Polonnaruwa' },
  'q.district.puttalam': { value: 'Puttalam' },
  'q.district.ratnapura': { value: 'Ratnapura' },
  'q.district.trincomalee': { value: 'Trincomalee' },
  'q.district.vavuniya': { value: 'Vavuniya' },
