...
const Login = () => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Redirect or Popup completion will handle the rest
    } catch (error: any) {
      ...
      if (error?.code === 'auth/popup-closed-by-user') {
        ...
        // Fallback to error message but keep it clean if possible
        errorMessage = error.message;
      }

      setGoogleError(errorMessage);
      setIsGoogleLoading(false); // Only stop loading on error, as redirect keeps loading
    }
  };
